...
public class LivreMercado {
    ...
    private Autenticador_if autenticador;
     ...
     */
    public LivreMercado(ContaBancaria contaMercado) {
        this.contaMercado = contaMercado;
        this.clientes = new ArrayList<>();
        this.autenticador = new AutenticadorDefault(); // TODO: Talvez uma fábrica?
     ...
     * - Itera o estoque (de trás para frente) para remover ou atualizar as quantidades dos itens comprados.
     ...
     */
    public void setAutenticador(Autenticador_if autenticador) {
