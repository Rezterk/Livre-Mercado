...
public class Preenchedor {
     ...
     */
    public static void inicializaMercado(LivreMercado mercado) {
        ...
        for (int i = 1; i <= 10; i++) {
            ...
            Cliente cliente = new Cliente(".", "Cliente_" + i, endereco, conta);
    ...
    private static int cadastraProdutosNaCategoriaESubcategorias(Categoria categoria, List<Cliente> vendedores, int produtoContador) {
        Random random = new Random();
        for (int i = 0; i < 5; i++) {
